        ...
        <div className="col-md-offset-2 col-md-8">
            ...
            <div className="panel panel-default">
                <div className="panel-heading">
                    <h2 className="panel-title text-center">Add a Product!</h2>
                </div>
                <div className="panel-body">
                    <form name="product-form" action="" onSubmit={() => this.props.submit()} noValidate>
                    <div className="form-group text-left">
                          <label htmlFor="caption">Name</label>
                          <input id="name" type="text" className="form-control" placeholder="Enter the title" onChange={() => this.props.setProduct()} />
                    </div>
                    <div className="form-group text-left">
                          <label htmlFor="description">Description</label>
                          <textarea id="description" type="text" className="form-control" placeholder="Enter the description" rows="5" onChange={() => this.props.setProduct()} ></textarea>
                    </div>
                    <div className="form-group text-left">
                        <label htmlFor="price">Year</label>
                        <input id="year" type="number" className="form-control" placeholder="Enter the year" onChange={() => this.props.setProduct()} />
                    </div>
                    <div className="form-group text-left">
